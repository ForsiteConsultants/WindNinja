...
def processWN(init_method: str,
              ...
              ws_grid: str = None,
              wd_grid: str = None,
              wx_station_filename: str = None) -> None:
    # Run WindNinja
    print('Processing WindNinja data')
    if init_method == 'pointInitialization':
        # print('\tGenerating daily WindNinja data using point initialization')
        WN(
        ...
        print('\tGenerating daily WindNinja data using wind grid initialization')
        WN(
            num_threads=num_threads,
            output_path=output_path,
            elevation_file=elevation_file,
    ...
    # Run WindNinja for hourly data
    # print('\tGenerating hourly WindNinja data using point initialization')
    # WN(hourlyFolder,
    #    elev_data_hourly,
    #    num_threads=16,
